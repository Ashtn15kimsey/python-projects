...
def describe_game(name):
    """
      ...
      playing again and coninue with the game
  """
      ...
      while stop:
          if name == "":
              ...
              if name != "":
                ...
                print("but at the end of the game your fate /nwill be sealed by your action")
                stop = False
                return name
...
def score(nice,mean,name):
    #score function is being passed the values stored within the the 3 variables
